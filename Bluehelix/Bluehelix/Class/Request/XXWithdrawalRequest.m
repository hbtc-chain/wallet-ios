...
@implementation XXWithdrawalRequest
...
- (void)createSignString {
    ...
    value[@"from_cu"] = self.transactionModel.fromAddress;
    value[@"to_multi_sign_address"] = self.transactionModel.toAddress;
