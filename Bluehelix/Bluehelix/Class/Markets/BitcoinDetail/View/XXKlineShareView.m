...
//        if (KConfigure.shareModel.logoImage) {
//            _logoImageView.image = KConfigure.shareModel.logoImage;
//        }
    }
...
- (XXLabel *)nameLabel {
    if (_nameLabel == nil) {
//        NSString *name = KString(KConfigure.shareModel.title);
//        if (name.length == 0) {
//            name = kApp_Name;
//        }
//        _nameLabel = [XXLabel labelWithFrame:CGRectMake(CGRectGetMaxX(self.logoImageView.frame) + 8, self.height/2 - 24, 200, 24) text:name font:kFontBold18 textColor:kMainTextColor];
    }
    return _nameLabel;
}
...
- (XXLabel *)exLabel {
    if (_exLabel == nil) {
//        NSString *name = KString(KConfigure.shareModel.subTitle);
//        if (name.length == 0) {
//            name = LocalizedString(@"DigitalAssetTradingPlatform");
//        }
//        _exLabel = [XXLabel labelWithFrame:CGRectMake(CGRectGetMaxX(self.logoImageView.frame) + 8, CGRectGetMaxY(self.nameLabel.frame), 200, 24) text:name font:kFontBold14 textColor:kMainTextColor];
    }
    return _exLabel;
}
...
//        if (KConfigure.shareModel.openUrl.length > 0) {
//            _codeImageView.backgroundColor = kMainTextColor;
//            _codeImageView.image = [XCQrCodeTool createQrCodeWithContent:KConfigure.shareModel.openUrl];;
//        } else {
