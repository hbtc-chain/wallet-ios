...
- (XXButton *)copyBtn {
    if (!_copyBtn) {
        MJWeakSelf
        _copyBtn = [XXButton buttonWithFrame:CGRectMake(K375(16), self.height - 54, kScreen_Width - K375(32), kBtnHeight) title:LocalizedString(@"CopyKeystore") font:kFontBold18 titleColor:[UIColor whiteColor] block:^(UIButton *button) {
            [weakSelf copyAction];
        }];
